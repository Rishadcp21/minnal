...
module.exports = {
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/Legend_god001' : process.env.IG,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://www.linkpicture.com/q/PicsArt_12-01-09.26.44_3.jpg' : process.env.ALL_IMG,
    ...
    YAK: process.env.YAK === undefined ? '917510241003' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUDO: process.env.SUDO === undefined ? '917510241003,0' : process.env.SUDO,
    DEBUG: DEBUG,
